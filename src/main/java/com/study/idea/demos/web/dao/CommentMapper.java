...
public interface CommentMapper {
    @Select("select id,update_time as updateTime,status,content,reply_id as replyId,user_id as userId,course_id as courseId from comment where reply_id=#{replyId}")
